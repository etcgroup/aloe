 ...
 */
public class SegmentationStudy {
    //A study of different segmentation parameters
    public static void main(String[] args) {
        String studyName = "Segmentations-human";
        ...
        {//Nothing but bag of words, with as many words removed as possible
            ParameterizedFeatureConfig features = new ParameterizedFeatureConfig("bag-unstemmed-unstopped");
        ...
        {//Now the works
            ParameterizedFeatureConfig features = new ParameterizedFeatureConfig("the-works-unstemmed-unstopped");
...
//        classifierConfigs.add(new WekaClassifierConfig("weka.classifiers.functions.Logistic", "-R 1.0 -M -1"));
        ...
        {
            DefaultDataConfig dataConfig = new DefaultDataConfig("seg-1-human");
            dataConfig.setSegmentationId(1);
            dataConfig.setRemoveSystemMessages(true);
            dataConfigs.add(dataConfig);
        }
        {
            DefaultDataConfig dataConfig = new DefaultDataConfig("seg-2-human");
            dataConfig.setSegmentationId(2);
            dataConfig.setRemoveSystemMessages(true);
            dataConfigs.add(dataConfig);
        }
        {
            DefaultDataConfig dataConfig = new DefaultDataConfig("seg-3-human");
            dataConfig.setSegmentationId(3);
            dataConfig.setRemoveSystemMessages(true);
            dataConfigs.add(dataConfig);
        }
        {
            DefaultDataConfig dataConfig = new DefaultDataConfig("seg-4-human");
        ...
        {
            DefaultDataConfig dataConfig = new DefaultDataConfig("seg-7-human");
            dataConfig.setSegmentationId(7);
            dataConfig.setRemoveSystemMessages(true);
            dataConfigs.add(dataConfig);
        }
        {
            DefaultDataConfig dataConfig = new DefaultDataConfig("seg-8-human");
            dataConfig.setSegmentationId(8);
            dataConfig.setRemoveSystemMessages(true);
            dataConfigs.add(dataConfig);
        }
        {
            DefaultDataConfig dataConfig = new DefaultDataConfig("seg-9-human");
            dataConfig.setSegmentationId(9);
            dataConfig.setRemoveSystemMessages(true);
            dataConfigs.add(dataConfig);
        }
