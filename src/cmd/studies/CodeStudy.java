...
//        List<Integer> codesToTest = Arrays.asList(84, 73, 89, 79, 108);//considering, annoyance, frustration, surprise, serenity
        ...
        {
            DefaultExperimentConfig expConfig = new DefaultExperimentConfig(DefaultExperimentConfig.BalancingStrategy.Downsample);
            experimentConfigs.add(expConfig);
        }
...
//        classifierConfigs.add(new WekaClassifierConfig("weka.classifiers.functions.Logistic", "-R 1.0 -M -1"));
        ...
        { //and try a plain window
            WindowDataConfig dataConfig = new WindowDataConfig("window-2");
            dataConfig.setMaxWindowSize(2);
        ...
        { //and try a sliding window
            SlidingWindowDataConfig dataConfig = new SlidingWindowDataConfig("slide-3-1");
