 ...
 * original code by Michael Brooks
 */
public class FrenchFeatureExtractionImpl implements FeatureExtraction {

    private Loggable.Verbosity verbosity = Loggable.Verbosity.Normal;

    @Override
    public ExampleSet extractFeatures(ExampleSet basicExamples, FeatureSpecification spec) {
        ExampleSet examples = basicExamples;

        if (this.verbosity.ordinal() > Loggable.Verbosity.Quiet.ordinal()) {
    ...
    @Override
    public void setVerbosity(Loggable.Verbosity verbosityLevel) {
