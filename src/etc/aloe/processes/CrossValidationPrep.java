 ...
 */
public class CrossValidationPrep<T extends LabelableItem> {
     ...
     */
    protected List<T> stratStep(List<T> instances, int numFolds) {
     ...
     */
    public void swap(List<T> instances, int i, int j) {
